    ...
    (err, result) => {
      ...
      db.query(
        ...
        (err, resultid) => {
          ...
          db.query(
            "INSERT INTO joueur (nom_jo, prenom_jo, nationalite_jo, poste_jo, num_mai_jo, age_jo, taille_jo, poids_jo,id_co_jo) VALUES (?,?,?,?,?,?,?,?,?) ",
            [
              newjoueur.nom,
              newjoueur.prenom,
...
exports.gererJoueur = async (req, res) => {
  ...
  db.query(
    "SELECT id_jo,nom_jo, prenom_jo, nationalite_jo, poste_jo, num_mai_jo, age_jo, taille_jo, poids_jo,compte.email_co FROM joueur JOIN compte ON joueur.id_co_jo = compte.id_co; ",
    (err, result) => {
      if (err) {
